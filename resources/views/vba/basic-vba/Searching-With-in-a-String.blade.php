...
@section('application-title')
  <title> Excel VBA - Searching With in a String (Hindi)</title>    
@endsection
        ...
        <div class="col-sm-8 single-left">
            <div class="song">
                <div class="video-grid">
                    <iframe src="https://www.youtube.com/embed/VQHrkcrNgjM?autoplay=0&rel=0&modestbranding=1&mute=0&controls=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                    
                </div>
                <div class="song-info">
                    <h3> Excel VBA - Searching With in a String (Hindi)
                            <a href="enable-developer-tab">                                <img src="{{asset('images/next.png')}}" style="margin-top: -6px;"> </a>  
                            <a href="{{ asset('vba_codes/StringFunctions/SearchingString/Searching-String-vba-text-functions.xlsm')}}"><img src="{{asset('images/download_code.png')}}" width="50" height="30" alt="Download code files" class="float-right" />
                            </a>
                    </h3>   
                </div>
            </div>
...
data-parent-playlist="VBA Tutorials For Beginners (Hindi)">
                    ...
                    <div class="published">
                    <div class="load_more"> 
                        <ul id="text-description" data-description="text-description" data-video_id="VQHrkcrNgjM">
            ...
            <div class="all-comments-info">
                ...
                <div class="box">
                    <form id="post_comment_form" name="post_comment_form" method="POST" enctype="multipart/form-data">
                      ...
                      <input type="hidden" id="video_id" name="video_id" value="VQHrkcrNgjM" />
