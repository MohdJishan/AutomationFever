...
<meta name="description" content="**replace** description" />
<meta name="robots" content="noodp"/>
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="website" />
<meta property="og:title" content="**replace** title" />
<meta property="og:description" content="**replace** description" />
<meta property="og:url" content="http://www.automationfever.com/" />
<meta property="og:site_name" content="AutomationFever" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:description" content="**replace** description" />
<meta name="twitter:title" content="**replace** title" />
    ...
    <div class="show-top-grids">
        <div class="col-sm-8 single-left">
            <div class="song">
                ...
                <div class="song-info">
                    <h3> **replace** videotitle
                            <a href="enable-developer-tab">
                                <img src="{{asset('images/next.png')}}" style="margin-top: -6px;">
                            </a>  

                            <a href="{{ asset('vba_codes/'. **replace** filedownload)}}"><img src="{{asset('images/download_code.png')}}" width="50" height="30" alt="Download code files" class="float-right" />
                            </a>
                    </h3>	
                </div>
            </div>
            ...
            <div class="published">
                {{-- <script src="{{ asset('jquery.min.html')}}"></script> --}}
                    ...
                    <div class="load_more">	
                        <ul id="myLista" data-playlistname="**replace** playlistname" data-published-datetime="**replace** videouploadtime">
                            
                                <h4>Published on **replace** videouploaddatetime</h4>
                                    <p>
                                        **replace** video_description
                                    </p>
                        </ul>
                    </div>
					</div>
					<div class="published">
					<div class="load_more">	
                        <ul id="text-description" data-description="text-description" data-video_id="**replace** video_id">
            ...
            <div class="all-comments-info">
                ...
                <div class="box">
                    <form id="post_comment_form" name="post_comment_form" method="POST" enctype="multipart/form-data">
                      ...
                      <input type="hidden" id="video_id" name="video_id" value="**replace** video_id" />
