...
@section('application-title')
  <title> Excel VBA - Open VB Editor On Custom Button Click  (Hindi)</title>    
@endsection
        ...
        <div class="col-sm-8 single-left">
            <div class="song">
                <div class="video-grid">
                    <iframe src="https://www.youtube.com/embed/HpEFNVbguNQ?autoplay=0&rel=0&modestbranding=1&mute=0&controls=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                    
                </div>
                <div class="song-info">
                    <h3> Excel VBA - Open VB Editor On Custom Button Click  (Hindi)

                            <a href="{{ asset('vba_codes/VbEditor/OpenVbEditorOnButtonClick/OpenVbEditorOnButtonClick.xlsm')}}"><img src="{{asset('images/download_code.png')}}" width="50" height="30" alt="Download code files" class="float-right" />
                            </a>
                    </h3>   
                </div>
            </div>
...
data-parent-playlist="">
                    ...
                    <div class="published">
                    <div class="load_more"> 
                        <ul id="text-description" data-description="text-description" data-video_id="HpEFNVbguNQ">
            ...
            <div class="all-comments-info">
                ...
                <div class="box">
                    <form id="post_comment_form" name="post_comment_form" method="POST" enctype="multipart/form-data">
                      ...
                      <input type="hidden" id="video_id" name="video_id" value="HpEFNVbguNQ" />
