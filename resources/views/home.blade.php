...
@section('content')
  ...
  <!--Scrollable tab example -->
          ...
          <li role="presentation" class="active"><a href="#basic-vba-tab" role="tab" data-toggle="tab" style="color: #2D545E;">Basic VBA</a></li>
          <li role="presentation"><a href="#advancedvba" role="tab" data-toggle="tab" style="color: #2D545E;">Advanced VBA</a></li>
          <li role="presentation"><a href="#vbaprojects" role="tab" data-toggle="tab" style="color: #2D545E;">VBA Projects</a></li>
          <li role="presentation"><a href="#exceltipsandtricks" role="tab" data-toggle="tab" style="color: #2D545E;">Excel - Tips & Tricks</a></li>
          <li role="presentation"><a href="#uipath" role="tab" data-toggle="tab" style="color: #2D545E;">UiPath</a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="advancedvba">
                <div class="recommended">
                    <div class="recommended-grids">
                         <div  id="top" class="callbacks_container">
                            <ul class="rslides" id="slider4" data-series-id="advanced-vba-series">
                    ...
                    <div class="accordion" id="accordionExample"> 
                        <div class="card"> 
                            <div class="card-header" id="headingOne"> 
                                <h2 class="mb-0"> 
                                    <span class="float-right" style="color:white"><i class="fa fa-server"></i> 101</span>
                                    <button type="button"
                                        class="btn btn-link header-button-collapse"
                                        data-toggle="collapse"
                                        data-target="#basicvba-list" aria-expanded="true"> 
                            ...
                            <div id="basicvba-list" class="collapse show in"
                        ...
                        <div class="card"> 
                            <div class="card-header" id="headingTwo"> 
                                <h2 class="mb-0"> 
                                    <span class="float-right" style="color:white"><i class="fa fa-server"></i> 59</span>
                                    <button type="button"
