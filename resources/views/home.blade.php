...
@section('meta_data')
    ...
    <meta name="description"
        content="You can watch excel vba videos here. We are trying to make you understand every topic of vba." />
...
@section('slider')
    ...
    <div id="jssor_1"
        style="position:relative;margin:0 auto;top:-20px;left:-15px;width:1600px;height:420px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-009-spin"
            style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;"
                src="{{ asset('img/spin.svg') }}" />
        </div>
        <div data-u="slides"
            style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:420px;overflow:hidden;">
            <div style="background-color:#e7e1d6;">
                ...
                <div data-ts="flat" data-p="275" data-po="40% 50%"
                    ...
                    <div data-to="50% 50%" data-t="0"
                        style="left:50px;top:520px;width:400px;height:100px;position:absolute;color:#E96429;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">
                        AUTOMATION</div>
                    ...
                    <div data-to="50% 50%" data-t="5"
                        style="left:50px;top:710px;width:700px;height:100px;position:absolute;color:#E96429;font-family:'Roboto Condensed',sans-serif;font-size:84px;font-weight:900;letter-spacing:0.5em;">
                        FEVER</div>
                </div>
            </div>
            <div>
                ...
                <div data-ts="flat" data-p="540" data-po="40% 50%"
                    style="left:0px;top:0px;width:1600px;height:420px;position:absolute;">
                    <div data-to="50% 50%" data-ts="preserve-3d" data-t="6"
                        ...
                        <svg viewbox="0 0 800 60" data-to="50% 50%" width="800" height="60" data-t="7"
                            ...
                            <text fill="#ffff" stroke="#ff9500" stroke-width="2" text-anchor="middle" x="400" y="60">START
                                LEARNING WITH US
                            </text>
                        </svg>
            ...
            <div>
                ...
                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:420px;position:absolute;">
                    <div data-to="50% 50%" data-t="13"
                        ...
                        <div
                            style="left:94px;top:35px;width:480px;height:90px;position:absolute;color:rgba(233,100,41);font-family:'Roboto Condensed',sans-serif;font-size:72px;line-height:1.2;">
                            SUBSCRIBE</div>
                        <div
                            style="left:307px;top:115px;width:400px;height:50px;position:absolute;color:rgba(2555, 255, 255, 0.5);font-family:'Roboto Condensed',sans-serif;font-size:42px;line-height:1.1;text-align:center;background-color:rgb(45 84 94);">
                            <a href="" style="color:rgba(2555, 255, 255);">@automationfever</a>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:420px;position:absolute;">
                    <div data-to="50% 50%" data-t="14"
                        ...
                        LEARN STEP BY STEP<br />FROM BEGINNING</div>
                    ...
                    <img data-to="50% 50%" data-t="16"
                        style="left:1330px;top:250px;width:112px;height:100px;position:absolute;opacity:0;max-width:172px;"
                        data-src="img/automation-fever-icon.png" />
                </div>
            </div>
        </div>
        <!-- Bullet Navigator -->
...
@section('content')
    ...
    <div class="col-sm-12 col-md-12">
        <div class="main-grids" style="padding: 0 0 0 2px;">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class=""><a href="#basic-vba-tab" role="tab" data-toggle="tab"
                        style="color: #2D545E;">Basic VBA</a></li>
                <li role="presentation"><a href="#advancedvba" role="tab" data-toggle="tab" style="color: #2D545E;">Advanced
                        VBA</a></li>
                <li role="presentation"><a href="#vbaprojects" role="tab" data-toggle="tab" style="color: #2D545E;">VBA
                        Projects</a></li>
                <li role="presentation"><a href="#exceltipsandtricks" role="tab" data-toggle="tab"
                        style="color: #2D545E;">Excel -
                        Tips & Tricks</a></li>
                <li role="presentation"><a href="#uipath" role="tab" data-toggle="tab" style="color: #2D545E;">UiPath</a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="basic-vba-tab">
                    <div class="recommended">
                        <div class="recommended-grids">
                            <div id="top" class="callbacks_container">
                                <ul class="rslides" id="slider3" data-series-id="basic-vba-series">
                                    {{-- Basic VBA Videos will be load here --}}
                                </ul>
                            </div>
                        </div>
                    </div>
                </div> {{-- end of id="basic-vba-tab" --}}

                <div role="tabpanel" class="tab-pane" id="advancedvba">
                    <div class="recommended">
                        <div class="recommended-grids">
                            <div id="top" class="callbacks_container">
                                <ul data-series-id="advanced-vba-series">
                                    {{-- Advanced VBA Videos will be load here --}}
                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane" id="vbaprojects">
                    <div class="recommended">
                        <div class="recommended-grids">
                            <div id="top" class="callbacks_container">
                                <ul data-series-id="vba-projects-series">
                                    {{-- VBA Projects Videos will be load here --}}
                                </ul>
                            </div>
                        </div>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane" id="exceltipsandtricks">
                    <div class="recommended">
                        <div class="recommended-grids">
                            <div id="top" class="callbacks_container">
                                <ul data-series-id="excel-tips-and-tricks-series">
                                    {{-- VBA Projects Videos will be load here --}}
                                </ul>
                            </div>
                        </div>
                ...
                <div role="tabpanel" class="tab-pane" id="uipath">
                    Comming Soon
                </div>
            </div>
        </div>
                ...
                <div class="recommended-grids" style="color:#2D545E;">
                    ...
                    <div class="col-sm-12 col-md-6" style="margin-top:15px">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 offset-md-1">
                                <div class="card ccc">
                                    <a href="#" style="text-decoration: none;"><img src="course_img/vba_home.png"
                                            class="card-img-top" alt="..." />
                                        <div class="card-body ccb">
                                            <p class="card-text float-right"
                                                style="text-align:center; padding-top:6px;font-size:12;">
                                                ({{$basicvba_videoCount}})
                                            </p>
                            ...
                            <div class="col-sm-12 col-md-10 offset-md-1">
                                <div class="card ccc">
                                    <a href="#" style="text-decoration: none;">
                                        <img src="course_img/vba_home.png" class="card-img-top" alt="..." />
                                        <div class="card-body ccb">
                                            <p class="card-text float-right"
                                                style="text-align:center; padding-top:6px;font-size:12;">
                                                ({{$advanced_videoCount}})
                    ...
                    <div class="col-sm-12 col-md-6" style="margin-top:15px">
                        <div class="row">
                            <div class="col-sm-12 col-md-10 offset-md-1">
                                <div class="card ccc">
                                    <a href="#" style="text-decoration: none;"><img src="course_img/excel_home.png"
                                            class="card-img-top" alt="..." />
                                        <div class="card-body ccb">
                                            <p class="card-text float-right"
                                                style="text-align:center; padding-top:6px; font-size:12;">
                                                ({{$exceltipandtricks_videoCount}})
                                            </p>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link header-button-collapse"
                                            data-toggle="collapse" data-target="#basicvba-list">
                                ...
                                <div id="basicvba-list" class="collapse" aria-labelledby="headingOne"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link collapsed header-button-collapse"
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link collapsed header-button-collapse"
                                            ...
                                            <i class="fa fa-plus-circle"></i>
                                            <span style="padding: 0px 0px 0px 10px !important;">Excel - Tips & Tricks
                                            </span>
                                        </button>
                                    </h2>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                    data-parent="#accordionExample">
                                    <div class="card-body" style=" max-height: 300px; overflow:scroll;">
                                        <dd id="excel-tips-and-tricks-dl">
    ...
    <script>
        ...
        //Loading Recent Advanced VBA Videos using AJAX Request
        $.post("{{ URL::route('loadAdvancedVbaVideos') }}", {}, function(data) {
            $("ul[data-series-id='advanced-vba-series']").html(data.html);
        });

        //Loading Recent VBA Projects Videos using AJAX Request
        $.post("{{ URL::route('loadVbaProjectsVideos') }}", {}, function(data) {
            $("ul[data-series-id='vba-projects-series']").html(data.html);
        });

        //Loading Recent VBA Projects Videos using AJAX Request
        $.post("{{ URL::route('loadExcelTipsAndTricksVideos') }}", {}, function(data) {
            $("ul[data-series-id='excel-tips-and-tricks-series']").html(data.html);
        });

        //Load Basic VBA Tutorials List here
        $.post("{{ URL::route('basic-vba-tutorials-list') }}", {}, function(data) {
             $("#basic-vba-dl").html(data.html);
        });

        //Load Advanced VBA Tutorials List here
        $.post("{{ URL::route('advanced-vba-tutorials-list') }}", {}, function(data) {
             $("#advanced-vba-dl").html(data.html);
        });

        //Load Excel Tips And Tricks Tutorials List here
        $.post("{{ URL::route('excel-tips-and-tricks-tutorials-list') }}", {}, function(data) {
             $("#excel-tips-and-tricks-dl").html(data.html);
        });
